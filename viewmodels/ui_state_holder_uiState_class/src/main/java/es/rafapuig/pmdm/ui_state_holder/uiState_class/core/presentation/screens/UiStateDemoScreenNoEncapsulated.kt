...
@Composable
fun UiStateDemoScreen_NoEncapsulated(
    name: String,
    isUpperCase: Boolean,
    ...
    Scaffold(
        ...
        Column(
            ...
            TextField(
                ...
                visualTransformation = if (isUpperCase) UpperCaseVisualTransformation() else VisualTransformation.None
            )
            Row(
...
@Composable
fun UiStateDemoScreen_NoEncapsulatedPreview() {
    PMDMComposeTheme {
