...
fun TemperatureConverterRoot(viewModel: TemperatureConverterViewModel = viewModel()) {
    ComposeExercisesTheme {
        Scaffold { innerPadding ->
            ...
            val celsiusTemperature by viewModel.celsiusTemperature.collectAsStateWithLifecycle()
            val fahrenheitTemperature by viewModel.fahrenheitTemperature.collectAsStateWithLifecycle()
