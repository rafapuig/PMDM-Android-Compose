...
import es.rafapuig.pmdm.compose.viewmodel.counter.mvi_viewmodel.screens.CounterScreenRoot
import es.rafapuig.pmdm.compose.viewmodel.counter.mvi_viewmodel.screens.MVICounterScreenRoot
...
class CounterActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.onAction(CounterAction.Set(5))
        ...
        setContent {
            PMDMComposeTheme {
                ...
                /**
                 * o dejar que use el ViewModel por defecto declarado en su parámetro
                 * viewModel
                 */
