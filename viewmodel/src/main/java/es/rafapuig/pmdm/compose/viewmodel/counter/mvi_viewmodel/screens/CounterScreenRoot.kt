package es.rafapuig.pmdm.compose.viewmodel.counter.mvi_viewmodel.screens
...
import es.rafapuig.pmdm.compose.viewmodel.counter.mvi_viewmodel.CounterAction
import es.rafapuig.pmdm.compose.viewmodel.counter.mvi_viewmodel.CounterViewModel
...
fun CounterScreenRoot(viewModel: CounterViewModel = viewModel()) {
    ...
    CounterScreen(
        ...
        onIncrement = {viewModel.onAction(CounterAction.Increment)},
        onDecrement = {viewModel.onAction(CounterAction.Decrement)},
        onReset = {viewModel.onAction(CounterAction.Reset)}
    )
