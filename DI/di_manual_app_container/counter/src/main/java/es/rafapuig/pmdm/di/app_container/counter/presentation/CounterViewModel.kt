...
import es.rafapuig.pmdm.di.app_container.counter.CounterApplication
...
class CounterViewModel(
    ...
    companion object {
        val Factory = viewModelFactory {
            initializer {
                val appContainer = (this[APPLICATION_KEY] as CounterApplication).container
                val repository = appContainer.counterRepository
