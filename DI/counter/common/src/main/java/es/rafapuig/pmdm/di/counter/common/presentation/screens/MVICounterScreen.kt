package es.rafapuig.pmdm.di.counter.common.presentation.screens
...
import es.rafapuig.pmdm.di.counter.common.presentation.CounterAction
import es.rafapuig.pmdm.di.counter.common.presentation.CounterEvent
import es.rafapuig.pmdm.di.counter.common.presentation.CounterUiState
import es.rafapuig.pmdm.di.counter.common.presentation.ObserveAsEvents
import es.rafapuig.pmdm.di.counter.common.ui.theme.PMDMComposeTheme
...
fun MVICounterScreen(
    ...
    events: Flow<CounterEvent> = emptyFlow()
    ) {
