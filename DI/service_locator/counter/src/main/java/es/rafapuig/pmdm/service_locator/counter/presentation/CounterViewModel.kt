...
import es.rafapuig.pmdm.service_locator.counter.CounterServiceLocator
...
class CounterViewModel(
    ...
    companion object {
        val Factory = viewModelFactory {
            initializer {
                /** La clase pide la dependencia */
                // La clase consumidora (la factoria) busca lo que necesita en el Service Locator
                // Dependencia oculta (típico cuando se usa Service Locator)
                val repository = CounterServiceLocator.counterRepository
